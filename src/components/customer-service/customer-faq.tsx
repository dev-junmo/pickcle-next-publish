...
const CustomerFaq: NextPageWithLayout<Props> = () => {
  ...
  return (
    <div className='my-[100px] sm:px-[30px] 2xl:px-0'>
      <b className='text-[25px] text-[#e93963]'>FAQ</b>
      <div className='mb-[100px] mt-[50px]'>
        <ul className='flex flex-wrap justify-center gap-x-[36px] gap-y-[40px]'>
      ...
      <div className='after:clear-both after:block'>
        ...
        <Link
          href='/community/faq'
          className='float-right mr-[21px] mt-[7px] inline-block text-base text-[#fff]'
        >
          더보기 &gt;
        </Link>
      </div>
...
CustomerFaq.getLayout = page => <Layout>{page}</Layout>;
