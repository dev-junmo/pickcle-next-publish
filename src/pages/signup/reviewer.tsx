...
const Reviewer: NextPageWithLayout<Props> = () => {
  const {
    register,
    watch,
  ...
  const [email, emailForm, password, passwordCheck, phoneNumber, name, nickname] = watch([
    'email',
    'emailForm',
    'password',
    'passwordCheck',
  ...
  useEffect(() => {
    ...
    if (email && password && phoneNumber && name && nickname) {
      setIsActive(true);
    } else {
      setIsActive(false);
    }
  ...
  }, [watch, email, password, phoneNumber, name, nickname]);
  ...
  const onSubmitSignUp = (data: FormValue) => {
  ...
  return (
    <div
      className={`flex items-center justify-center px-[30px] py-[50px] xl:py-[150px] ${
        isNext ? 'sm:px-[30px]' : 'sm:px-0'
      }`}
    >
      <div
        className={`flex ${
          isNext
            ? 'ms:px-[50px] w-full rounded-[30px] px-[30px] sm:rounded-[50px] md:w-[965px] xl:rounded-[100px] xl:px-[130px]'
            : 'w-full rounded-[30px] px-[30px] sm:w-[825px] sm:rounded-[80px] sm:px-[100px]'
        } flex-col items-center bg-[#f6f6f6] py-[50px] sm:py-[80px]`}
      >
        <b className='text-[30px] font-medium'>리뷰어 회원가입</b>
        <form onSubmit={handleSubmit(onSubmitSignUp)}>
          {isNext ? (
            <SignUpCategory usrTpye='reviewer' />
          ) : (
            <div className='mt-[40px] w-full'>
              <div className='mb-[10px]'>
                <label htmlFor='email' className='cursor-auto text-[20px] font-medium'>
                  이메일 <span className='font-[500] text-[#f97090]'>＊</span>
                </label>
                <div className='mt-[15px] flex flex-col items-start gap-[10px] sm:flex-row sm:items-center sm:gap-0'>
                  ...
                  {/* // <select
                    //   className='relative mb-[25px] w-full rounded-[5px] border border-[#c0c0c0] bg-[url(/assets/icons/select-arrow.webp)] bg-[length:32px_32px] bg-[right_20px_top_9px] bg-no-repeat px-[10px] py-[12px] text-[#000]'
                    //   {...register('emailForm')}
                    //   onChange={e => {
                    ...
                    //     선택
                    //   </option>
                    //   <option key='gmail.com' value='gmail.com' className='text-[#000]'>
                    //     gmail.com
                    //   </option>
                    //   <option key='naver.com' value='naver.com' className='text-[#000]'>
                    //     naver.com
                    //   </option>
                    //   <option key='nate.com' value='nate.com' className='text-[#000]'>
                    //     nate.com
                    //   </option>
                    //   <option key='directly' value='직접 입력' className='text-[#000]'>
                    //     직접 입력
                    //   </option>
                    // </select> */}
                </div>
              ...
              <div className='mb-[10px]'>
                <label htmlFor='password' className='block cursor-auto text-[20px] font-medium'>
                  비밀번호 <span className='font-[500] text-[#f97090]'>＊</span>
                </label>
                <div>
                  <input
                    id='password'
              ...
              <div className='mb-[30px]'>
                <label htmlFor='phone-number' className='block cursor-auto text-[20px] font-medium'>
                  휴대폰 번호 <span className='font-[500] text-[#f97090]'>＊</span>
                </label>
              ...
              <div className='mb-[10px]'>
                <label htmlFor='name' className='block cursor-auto text-[20px] font-medium'>
                  이름 <span className='font-[500] text-[#f97090]'>＊</span>
                </label>
                <div>
                  <input
                    id='name'
                  ...
                  />
                  <small role='alert' className='mt-[7px] block h-[20px] text-xs text-[#d60000]'>
                    {errors.name?.message}
                  </small>
                </div>
              </div>
              <div className='mb-[30px]'>
                <label htmlFor='nickname' className='block cursor-auto text-[20px] font-medium'>
                  닉네임 <span className='font-[500] text-[#f97090]'>＊</span>
                </label>
                <input
                  id='nickname'
                  type='text'
              ...
              <div className='mb-[30px]'>
                <label htmlFor='gender' className='block cursor-auto text-[20px] font-medium'>
                  성별 <span className='font-[500] text-[#f97090]'>＊</span>
                </label>
                {/* <select className='mt-[15px] w-full rounded-[5px] border border-[#c0c0c0] bg-[url(/assets/icons/select-arrow.webp)] bg-[length:32px_32px] bg-[right_20px_top_9px] bg-no-repeat px-[10px] py-[12px] text-[#b4b4b4]'>
                  <option
                    key='select'
                    hidden
                    value=''
                ...
                <SelectBox
                  optionData={genderData}
                  placeholder='성별'
                  wrapClassName='relative mt-[15px] w-full'
                  btnClassName='w-full rounded-[5px] border border-[#c0c0c0] bg-[#fff] bg-[url(/assets/icons/select-arrow.webp)] bg-[length:32px_32px] bg-[right_20px_top_9px] bg-no-repeat px-[10px] py-[12px] text-left'
                />
              </div>
              <div className='mb-[30px]'>
                ...
                <div className='mt-[15px] w-full rounded-[10px] border border-[#c0c0c0] bg-white px-[12px] py-[20px] xl:px-[22px] xl:py-[30px]'>
                  <ul>
                    <li className='mb-[16px] text-[12px] sm:text-[16px] xl:text-[14px]'>
                    ...
                    <li className='text-[12px] sm:text-[16px] xl:text-[14px]'>
...
Reviewer.getLayout = page => <Layout>{page}</Layout>;
