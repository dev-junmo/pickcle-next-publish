...
const MakerProductIntroduction: NextPageWithLayout<Props> = () => {
      ...
      <div className='md:flex'>
        ...
        <div className='mx-auto w-full px-[20px] py-[100px] text-[#fff] xl:w-[1040px] xl:px-0 2xl:w-[1420px]'>
          <b className='block border-b border-b-[#fff] border-opacity-[0.8] pb-[25px] text-center text-[25px] font-[500] text-[#ffffff] 2xl:text-[30px]'>
            <span className='text-[#8586db]'>메이커</span>브랜드 제품소개서 등록하기
          ...
          <div className='mx-auto w-full xl:w-[1040px]'>
            <PortfolioInput userType='advertiser' contentType='maker' />
...
MakerProductIntroduction.getLayout = page => <Layout>{page}</Layout>;

export default MakerProductIntroduction;
