...
const PenaltyHistory: NextPageWithLayout<Props> = () => {
  ...
  return (
    <div className='md:flex'>
      <AdvertiserSidebar />
      <div className='mx-auto my-[100px] w-full px-[20px] text-center xl:w-[1020px] 2xl:w-[1400px]'>
        ...
        <div className='mt-[50px] rounded-[20px] bg-[#fff] p-[20px]'>
          ...
          <ul className='mt-[24px] hidden xl:flex'>
          ...
          <ul className='mt-[24px] flex flex-wrap gap-[20px] xl:hidden'>
              ...
              <div className='mb-[40px] flex items-center justify-between'>
                <div>
                  <div className='flex flex-col items-start sm:flex-row sm:items-center'>
                    <b className='mr-[15px] text-[20px] font-bold text-[#000000]'>
                      블랙 - 기간 내 경고 7회 누적
                    </b>
                    <span className='h-[26px] rounded-[30px] bg-[#e8e8e8] px-[13px] text-[14px] font-bold leading-[26px] text-[#f97090]'>
                      적용
                    </span>
                  </div>
                  <p className='my-[5px] text-[16px] font-[500] text-[#000000]'>
                    [브랜드명] 협찬방식
                  </p>
                  <span className='text-[14px] font-[500] text-[#929292]'>2023.08.14</span>
                </div>
                <Image
