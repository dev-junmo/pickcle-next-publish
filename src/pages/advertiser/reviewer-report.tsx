...
const ReviewerReport: NextPageWithLayout<Props> = () => {
  return (
    <div className='mx-auto my-[100px] w-full border-t border-[#ffffffbb] px-[20px] text-[#fff] xl:w-[1040px] xl:px-0 2xl:w-[1420px]'>
      <div className='mx-auto text-center xl:w-[753px]'>
        ...
        <div className='mt-[30px] text-left'>
          <div>
            ...
            <input
              className='mt-[15px] block h-[48px] w-full rounded-[5px] pl-[15px] text-[16px] font-[500] placeholder:text-[#cccccc]'
              placeholder='리뷰어의 정보(이메일, 연락처)을  입력해 주세요.'
            />
          </div>
        </div>
        <div className='mt-[30px] text-left'>
        ...
        <div className='mt-[30px]'>
          ...
          <button className='flex h-[50px] w-full items-center justify-center rounded-[5px] bg-[#c2c2f6]'>
            <Image
              ...
              height={30}
            />
            <span className='ml-[10px] text-[20px] font-bold text-[#000] sm:text-[20px]'>
              첨부하기
            </span>
          </button>
...
ReviewerReport.getLayout = page => <Layout>{page}</Layout>;
