      ...
      <div className='mx-auto w-[1420px] pt-[100px]'>
        ...
        <div className='mb-[150px] mt-[50px]'>
          ...
          <div className='flex justify-center pt-[100px]'>
            <button className='rounded-[10px] bg-[#c2c3d5] px-[48px] py-[10px] text-[20px] font-bold text-[#fff]'>
              공지사항목록
            </button>
          </div>
        </div>
