...
const MannerEvaluate: NextPageWithLayout<Props> = () => {
  return (
    <>
      <div className='mx-auto w-full px-[20px] py-[100px] text-[#fff] lg:w-[1040px] 2xl:w-[1420px]'>
        <b className='block border-opacity-[0.8] pb-[25px] text-center text-[25px] font-[500] text-[#ffffff] 2xl:text-[30px]'>
          받은 매너 평가
        </b>
        ...
        <div className='my-[100px] md:my-[150px]'>
          <ul className='flex flex-wrap gap-[30px] gap-y-[50px]'>
            <li className='flex w-full items-center justify-between rounded-[20px] border-[4px] border-[#f97090] bg-[#fff] px-[30px] py-[25px] md:w-[48%]'>
...
MannerEvaluate.getLayout = page => <Layout>{page}</Layout>;

export default MannerEvaluate;
