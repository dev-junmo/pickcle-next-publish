...
const ProposalReviewer: NextPageWithLayout<Props> = () => {
  return (
    <div className='relative'>
      <HomeBanner />
      <div className='mx-auto w-full px-[30px] xl:w-[1040px] xl:px-0 2xl:w-[1420px]'>
        <CategoryTab />
        <CategoryContents actionType='supporter' userType='reviewer' />
      </div>
    </div>
  );
};

ProposalReviewer.getLayout = page => <Layout>{page}</Layout>;

export default ProposalReviewer;
