...
const MakerPicture: NextPageWithLayout<Props> = () => {
  return (
    <div className='relative'>
      <HomeBanner />
      <div className='mx-auto w-full px-[30px] xl:w-[1040px] xl:px-0 2xl:w-[1420px]'>
        <CategoryTab />
        <CategoryContents actionType='maker' userType='reviewer' contentsType='사진' />
      </div>
    </div>
  );
};

MakerPicture.getLayout = page => <Layout>{page}</Layout>;

export default MakerPicture;
