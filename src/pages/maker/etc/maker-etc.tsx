...
const MakerEtc: NextPageWithLayout<Props> = () => {
  return (
    <div className='relative'>
      <HomeBanner />
      <div className='mx-auto w-full px-[30px] xl:w-[1040px] xl:px-0 2xl:w-[1420px]'>
        <CategoryTab />
        <CategoryContents actionType='maker' userType='reviewer' contentsType='기타' />
      </div>
    </div>
  );
};

MakerEtc.getLayout = page => <Layout>{page}</Layout>;

export default MakerEtc;
